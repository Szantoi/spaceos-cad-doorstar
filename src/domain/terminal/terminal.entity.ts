...
const TERMINAL_REGISTRY: Record<TerminalName, TerminalInfo> = {
  ...
  conductor: {
    ...
    workdir: '/opt/spaceos/terminals/conductor',
    role: 'coordinator',
    aliases: [],
  },
  backend: {
    ...
    workdir: '/opt/spaceos/terminals/backend',
    role: 'developer',
  ...
  frontend: {
    ...
    workdir: '/opt/spaceos/terminals/frontend',
    role: 'developer',
  ...
  designer: {
    ...
    workdir: '/opt/spaceos/terminals/designer',
    role: 'developer',
    aliases: [],
  },
  architect: {
    ...
    workdir: '/opt/spaceos/terminals/architect',
    role: 'support',
    aliases: [],
  },
  librarian: {
    ...
    workdir: '/opt/spaceos/terminals/librarian',
    role: 'support',
    aliases: [],
  },
  explorer: {
    ...
    workdir: '/opt/spaceos/terminals/explorer',
    role: 'support',
    aliases: [],
  },
};
