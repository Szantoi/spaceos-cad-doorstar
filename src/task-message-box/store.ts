...
// __dirname-based REPO_ROOT resolves incorrectly (lands outside Cabinet_bilder_scripts) —
// mirror mailbox.ts's pattern and prefer the explicit env var, same as TERMINALS_PATH there.
