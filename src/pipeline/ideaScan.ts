 ...
 *
 * "A project prototype generál implementációs ötleteket"
 *
 * Működés:
 * 1. Minden N percben (alapértelmezett: 30) elemzi a project prototype
 ...
 *   IDEA_SCAN_PROJECT_PATH=./docs/tasks/new
 */
...
const DEFAULT_CONFIG: IdeaScanConfig = {
  ...
  projectPath: process.env.IDEA_SCAN_PROJECT_PATH ||
    './docs/tasks/new',
  ideasDir: '/opt/spaceos/docs/planning/ideas',
  maxIdeasPerRun: 3,
  ideasThreshold: 5,
...
---
*Automatikusan generálva a project prototype*
`;
...
## Kontextus
Ez az ötlet a project prototype elemzéséből származik.
...
export async function runIdeaScan(
  ...
  const prompt = `# Project UI Prototype Elemzés

## Feladat
Elemezd a project portal prototípusát és generálj 2-3 konkrét implementációs ötletet.
