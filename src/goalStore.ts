...
const GOALS_DIR = '/opt/spaceos/store/goals';
const GOALS_LOG = '/opt/spaceos/logs/dispatcher/goals.log';
...
async function checkCheckpointStatus(
  ...
  const epicsPath = '/opt/spaceos/docs/projects/EPICS.yaml';
...
async function checkMessageStatus(
  ...
  const terminalsPath = '/opt/spaceos/terminals';
